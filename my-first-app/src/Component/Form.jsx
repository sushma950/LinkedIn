...
alt=""/>
<h2>Welcome Back</h2>
<p style={{color:"grey"}}>Don't miss your next oppurtunity.Sign in to stayupdated on your professional world </p>
               
<input style={{margin:"10px",borderRadius:"5px",height:"35px",width:"250px"}} name="username"
value={username} placeholder="Email or Phone"
...
onClick={()=>getData({username,password})}> Sign In</button>
<p style={{color:"rgb(34,84,354)"}}>Forgot password?</p>
<div>
<span>New to LinkedIn?</span>
<span style={{color:"rgb(34,84,354)",fontWeight:"bold"}}>Join Now</span>
</div>
            </div>
        )
    }
